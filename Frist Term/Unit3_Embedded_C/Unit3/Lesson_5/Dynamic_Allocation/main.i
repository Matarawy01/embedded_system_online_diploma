...
# 11 "Platform_Types.h"
# 1 "c:\\arm_toolchain\\bin\\../lib/gcc/arm-none-eabi/4.7.2/include/stdbool.h" 1 3 4
# 12 "Platform_Types.h" 2
...
uint8_t const const_variables[3] = {1,2,3};
uint8_t uninit_Gvariable[3];
...
int main(void)
{
 ...
 int i;
    ...
    *(( vuint32_t*) (0x40010800 + 0x04)) |=0x00200000;
    while(1)
    {
